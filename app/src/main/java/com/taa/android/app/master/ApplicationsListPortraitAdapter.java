 ...
 *
 */
public class ApplicationsListPortraitAdapter extends ArrayAdapter<App> 
{
    ...
    public ApplicationsListPortraitAdapter(Activity activity, ArrayList<App> apps) 
    {
         super(activity, R.layout.application_list_portrait, apps);	
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = minflater.inflate(R.layout.application_list_portrait, parent, false);
        }
